...
//   (never concatenated into `cmd`). Call sites today: playwright.cmd and
//   appium.cmd with literal args, plus sdkmanager.bat / avdmanager.bat with
//   AVD names and system images derived from flow metadata in the user's own
//   repo. Audit any new .cmd/.bat caller before merging.
