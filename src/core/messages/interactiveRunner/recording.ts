export const recordingMessages = {
  ...
  notFound:
    "That recording was not found on the runner. Use runner record status for the active recording or runner list-recordings for published history.",
  idUsed:
    "That recording id has already been used. Start a new recording with a new UUID.",
  failed:
    "The recording operation failed. If this was a stop, retry it with the same recording id to finish stopping or publishing it. Check runner list-recordings for its published status.",
  failedCapture:
    "The recording failed. Check runner list-recordings for its published status.",
