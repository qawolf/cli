...
| `4`  | `network`     | Apex unreachable, GCS download failure, registry unreachable, or a runner that could not serve the request now (unreachable, or a screen that is up but busy or restarting).                                                                                                 |
